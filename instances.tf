...
module "ACPCICD" {
  ...
  user_data       = "LISTEN_http=0.0.0.0:80 CHECK_http=${var.tester_ips["peering_tester_ip"]}:${var.tester_ports["peering_http_port"]} CHECK_ext_tableau=${var.tester_ips["ext_tableau"]}:${var.tester_ports["https_port"]} CHECK_int_tableau=${var.tester_ips["int_tableau"]}:${var.tester_ports["https_port"]} CHECK_bdm_web=${var.tester_ips["bdm_web"]}:${var.tester_ports["https_port"]} CHECK_gp_master=${var.tester_ips["gp_master"]}:${var.tester_ports["postgresql_port"]}"
